python -m transformer_chips.playground.benchmark.train \
    ...
    --out_path ./data/benchmark/racem/llama_7b \
    --figure_path ./data/figures/benchmark/racem/llama_7b \
...
python -m transformer_chips.playground.benchmark.train \
    ...
    --out_path ./data/benchmark/raceh/llama_7b \
    --figure_path ./data/figures/benchmark/raceh/llama_7b \
    --base_model ./model/Llama-2-7b-hf \
    --mlp_chip_hidden_dim 256 \
    --learning_rate 1e-5 \
    --weight_decay 0.01 \
